...
public class RequestHandler extends Thread {
	...
	private void response403Error(OutputStream outputStream, String url, String protocol) throws IOException {
		/*
		 ...
		 *  /error/403.html 내용
		 */
		File file = new File("./webapp/error/403.html");
		byte[] body = Files.readAllBytes(file.toPath());
		String contentType = Files.probeContentType(file.toPath());
		
		// response
		outputStream.write((protocol + " 403 OK\n").getBytes("UTF-8"));
		outputStream.write(("Content-Type:" + contentType + "; charset=utf-8\n").getBytes("UTF-8"));
		outputStream.write("\n".getBytes());
		outputStream.write(body);
	}
